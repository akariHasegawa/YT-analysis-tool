...
---
🎬 シーン1｜フック（0〜5秒）
[Kling AIに直接貼れる英語プロンプト。50〜80語。被写体・動作・カメラ・雰囲気を具体的に記述]

🎬 シーン2｜本編（5〜40秒）
[Kling AIに直接貼れる英語プロンプト。50〜80語。シーン1から自然につながる映像]

🎬 シーン3｜締め・CTA（40〜60秒）
[Kling AIに直接貼れる英語プロンプト。50〜80語。シーン2から自然につながる映像]

---
🔗 Extend用プロンプト（シーン延長時に使用）
[各シーンをKlingのExtend機能で延長する際に使える英語プロンプト。30〜50語。前のシーンとの連続性を保つ内容]

【注意】
- 各プロンプトは英語で書くこと（Kling AIは英語プロンプトが最も精度が高い）
...
渡された台本をもとに、シーン単位に分割した動画生成プロンプトを作成してください。

【ルール】
- 台本のフック・本編・締めの構成に沿ってシーン1〜3に分割する
- 各シーンは5〜10秒で完結する映像として設計する
- プロンプトは英語で書く（Kling AIは英語が最も精度が高い）
- 台本のセリフや展開を映像的に表現すること

【出力形式】
---
🎬 シーン1｜フック（0〜5秒）
[Kling AIに直接貼れる英語プロンプト。50〜80語]
...
---
🔗 Extend用プロンプト（シーン延長時に使用）
[各シーンをKlingのExtend機能で延長する際に使える英語プロンプト。30〜50語]

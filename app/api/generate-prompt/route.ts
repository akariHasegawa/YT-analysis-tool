...
- 「何が映っているか」「どう動くか」「カメラワーク」を具体的に書き、曖昧な表現で終わらせないこと
...
---
🎬 シーン1｜フック（0〜5秒）
[Kling AIに直接貼れる日本語プロンプト。被写体・動作・カメラ・雰囲気を具体的に100〜150字で記述]

🎬 シーン2｜本編（5〜40秒）
[Kling AIに直接貼れる日本語プロンプト。シーン1から自然につながる映像を100〜150字で記述]

🎬 シーン3｜締め・CTA（40〜60秒）
[Kling AIに直接貼れる日本語プロンプト。シーン2から自然につながる映像を100〜150字で記述]

---
🔗 Extend用プロンプト（シーン延長時に使用）
[各シーンをKlingのExtend機能で延長する際に使える日本語プロンプト。50〜80字。前のシーンとの連続性を保つ内容]
...
---
🎬 シーン1｜フック（0〜5秒）
[Kling AIに直接貼れる日本語プロンプト。100〜150字]
...
---
🔗 Extend用プロンプト（シーン延長時に使用）
[各シーンをKlingのExtend機能で延長する際に使える日本語プロンプト。50〜80字]
